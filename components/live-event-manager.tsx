  ...
  return (
    <div className="space-y-6">
      <form action={createEvent} className="grid gap-3 rounded-2xl border border-border p-4 sm:grid-cols-2">
        <div className="sm:col-span-2"><h2 className="font-serif text-lg font-bold">Create live event</h2><p className="mt-1 text-xs text-muted-foreground">Add a programme once. The Live Centre will keep showing it until its scheduled time.</p></div>
        ...
        <select name="provider" defaultValue="youtube" className="rounded-xl border border-border bg-background px-3 py-2 text-sm"><option value="youtube">YouTube</option><option value="streamyard">StreamYard</option><option value="other">Other</option></select>
        <input name="videoId" placeholder="YouTube video ID (optional)" className="rounded-xl border border-border bg-background px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-brand-green/30" />
