        ...
        {section === "add" && (
          <section className="grid gap-5 lg:grid-cols-[1.3fr_.7fr]">
            <div className="rounded-2xl border bg-card p-5">
              ...
              <button onClick={()=>setAdded(true)} className="mt-5 inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground"><Upload className="size-4" /> Queue for Knowledge Processing</button>
