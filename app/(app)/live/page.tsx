...
const filters = [{ label: "All Live", query: "live" }, { label: "Africa", query: "Africa live" }, { label: "World", query: "World live" }, { label: "News", query: "news live" }, { label: "Community", query: "community live" }]
