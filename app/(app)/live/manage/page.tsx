...
export default async function LiveManagePage() {
  ...
  if (!isLiveAdmin(user?.email)) {
    return (
      <div className="px-4 py-12 text-center">
        ...
        <h1 className="mt-4 font-serif text-xl font-bold">Broadcast control room</h1>
        <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground">This area is restricted to configured Africa & Beyond Live administrators.</p>
  ...
  return (
    <div className="px-4 py-5">
      ...
      <div className="mt-5 mb-6"><p className="text-xs font-bold uppercase tracking-wider text-brand-red">Broadcast control room</p><h1 className="mt-1 font-serif text-2xl font-bold">Manage Live Events</h1><p className="mt-1 max-w-2xl text-sm text-muted-foreground">Create and maintain the programmes that appear in the Africa & Beyond Live Centre.</p></div>
