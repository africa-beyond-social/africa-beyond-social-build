...
export default async function LiveManagePage() {
  ...
  return (
    <div className="px-4 py-5">
      ...
      <div className="mt-5 mb-6"><p className="text-xs font-bold uppercase tracking-wider text-brand-red">WIGOD creator tools</p><h1 className="mt-1 font-serif text-2xl font-bold">WIGOD Live Studio</h1><p className="mt-1 max-w-2xl text-sm text-muted-foreground">Create and publish live broadcasts inside WIGOD, with optional YouTube publishing. Social interaction remains native to WIGOD.</p></div>
      <WigodLiveStudio />
